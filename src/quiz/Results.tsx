...
export const Results = ({ fragrances, onRetakeQuiz, votes }: ResultProps) => {
  useGSAP(() => {
  ...
  const determineWinners = (
    ...
    if (votes.Terra === maxVotes) {
      winningTypes.push("Terra");
    }
    if (votes.Ignis === maxVotes) {
      winningTypes.push("Ignis");
    }
    if (votes.Aqua === maxVotes) {
      winningTypes.push("Aqua");
    }
