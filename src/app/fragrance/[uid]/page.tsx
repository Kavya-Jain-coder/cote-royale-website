    ...
    <Bounded className="py-10">
        ...
        <div className="grid grid-cols-1 items-center gap-10 pb-10 lg:grid-cols-2 ">
            ...
            <div className="relative mb-14 flex justify-center pb-10 ">
                ...
                <PrismicNextImage field = {page.data.bottle_image} width={600} height={600} priority className = "absolute top-[90%] -scale-y-100 [mask-image:linear-gradient(to_bottom,rgba(0,0,0,0)_70%,rgba(0,0,0,0.15)_100%)]" />
            ...
            <div className="text-white">
                ...
                <div className="space-y-6">
                    ...
                    <FragranceAttributes mood = {page.data.mood} scent_profile = {page.data.scent_profile}/>

                    <p className="mt-10 text-3xl font-light">
                        {formatPrice(page.data.price)}
                    </p>

                    <button className="w-full bg-white py-3 font-medium text-black uppercase transition hover:bg-neutral-200 duration-200 cursor-pointer">Add to bag</button>
